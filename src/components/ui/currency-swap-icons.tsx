...
import { Rayn, RaynTwo } from '@/components/icons/rayn';
...
export default function CurrencySwapIcons({
  ...
  return (
    <div className="flex items-center">
      ...
      <div className="whitespace-nowrap text-sm font-medium uppercase text-black ltr:ml-3 rtl:mr-3 dark:text-white"></div>
    </div>
  );
}
