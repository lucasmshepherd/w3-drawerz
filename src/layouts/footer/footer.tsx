...
export default function Footer() {
  ...
  const navigation = {
    ...
    company: [
      ...
      { name: 'Email', href: 'mailto:support@rewardz.network' },
  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      ...
      <div className="mt-20 border-t border-color8 pt-8 md:flex md:items-center md:justify-between">
        <div className="flex space-x-6 md:order-2">
          {navigation.social.map((item) => (
            <a
              key={item.name}
              href={item.href}
              className="text-gray-500 transition hover:text-color1 active:text-color1"
            >
